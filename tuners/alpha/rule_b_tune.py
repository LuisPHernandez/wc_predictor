...
print(
    f"total_pts   = {best['total_points']:.0f}"
)
...
print(
    f"Best fixed alpha : {best_fixed_col}"
)

print(
    f"Best fixed total : {best_fixed_total}"
)

print(
    f"Best Rule B      : {best['total_points']:.0f}"
)

print(
    f"Improvement      : {best['total_points'] - best_fixed_total:+.0f}"
)
